...
|---|---|---|---|---|---|---|---|
| [2.29.0](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.29.0) | Questa versione introduce il supporto per la creazione di versioni di anteprima delle risorse nel componente core Sites e corregge numerosi bug. | - | 6.5.21.0+ | 6,5 LTS GA | Continua | 8, 11 | 21 aprile 2025 |
